...
## TESTED (Latest Version):
  ...
  - It is come to our attention that some may experiencing sketch data upload problem when using board library v2.6.1 with spiffs plugin v 0.4.0. Please follow this [issue](https://github.com/samelement/ACS-M1128/issues/1) to get solution.
